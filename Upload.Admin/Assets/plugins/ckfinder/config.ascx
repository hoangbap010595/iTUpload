...
<script runat="server">
    ...
    //Phân quen sử dụng thư mục
        if (Session["GiaoVienIDSession"] != null && (Session[ "IsAuthorized" ] != null && (bool)Session[ "IsAuthorized" ] == true ) )
        {
            Session["CKFinder_UserRole"] = "Administrators";
            return true;
        }
        else if (Session["GiaoVienIDSession"] != null)
        {
            Session["CKFinder_UserRole"] = "GiangVien";
            return true;
        }
        else if (Session["HocSinhIDSession"] != null)
        {
            Session["CKFinder_UserRole"] = "HocSinh";
            return true;
        }
    ...
    public override void SetConfig()
    {
        ...
        LicenseName = "VNStudy";
        LicenseKey = "AXSELE4E2DW7YYJBMQ1U14DLMGQRPW28";
        ...
        AccessControl aclAdmin = AccessControl.Add();
        aclAdmin.Role = "Administrators";
        aclAdmin.ResourceType = "*";
        aclAdmin.Folder = "/";

        aclAdmin.FolderView = true;
        aclAdmin.FolderCreate = true;
        aclAdmin.FolderRename = true;
        aclAdmin.FolderDelete = true;

        aclAdmin.FileView = true;
        aclAdmin.FileUpload = true;
        aclAdmin.FileRename = true;
        aclAdmin.FileDelete = true;

        AccessControl aclHocSinh = AccessControl.Add();
        aclHocSinh.Role = "HocSinh";
        aclHocSinh.ResourceType = "Flash";
        aclHocSinh.Folder = "/";

        aclHocSinh.FolderView = false;
        aclHocSinh.FolderCreate = false;
        aclHocSinh.FolderRename = false;
        aclHocSinh.FolderDelete = false;

        aclHocSinh.FileView = false;
        aclHocSinh.FileUpload = false;
        aclHocSinh.FileRename = false;
        aclHocSinh.FileDelete = false;

        AccessControl aclGiangVien = AccessControl.Add();
        aclGiangVien.Role = "GiangVien";
        aclGiangVien.ResourceType = "*";
        aclGiangVien.Folder = "/";

        aclGiangVien.FolderView = true;
        aclGiangVien.FolderCreate = false;
        aclGiangVien.FolderRename = true;
        aclGiangVien.FolderDelete = true;

        aclGiangVien.FileView = true;
        aclGiangVien.FileUpload = true;
        aclGiangVien.FileRename = true;
        aclGiangVien.FileDelete = true;
